...
global TLFIndex    is 2.
global TLRIndex    is 3.
global BLFIndex    is 0.
global BRFIndex    is 1.
...
global MinFlapAngle is 100.
global TopFlapAngleDefoult is 132.
global BottomFlapAngleDefoult is 132.
global TargetForAngle is 60.//72=-74.19.//72.5=-74.90
...
until StageNo=2{ 
    ...
    if (ForeToVelAngle>175){
        if (SHIP:orbit:periapsis>37800){//37637 //37314
...
until StageNo=4{
    ...
    partlist[TLRIndex]:GETMODULE("ModuleRoboticServoHinge"):SETFIELD("Target Angle", MaxFlapAngle).//top right
...
function GetTelemetry{
    ...
    if (time:seconds-lastCount2>2){
        set lastCount2 to  time:seconds.
        LOG SHIP:GEOPOSITION:LNG + ", " + ship:altitude to mylog.csv.
    }
...
function SetFlapsVac{
    ...
    local PitchBreakMultiFactor is 2.
    ...
    partlist[TLRIndex]:GETMODULE("ModuleRoboticServoHinge"):SETFIELD("Target Angle", TRFAngle).//top right
